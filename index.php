...
<title>LetMeHACK-SUSL</title>
<!-- Bootstrap Core CSS -->
<link rel="stylesheet" href="css/bootstrap.min.css" type="text/css">
<!-- Custom Fonts -->
<link href='https://fonts.googleapis.com/css?family=Mrs+Sheppards%7CDosis:300,400,700%7COpen+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800;' rel='stylesheet' type='text/css'>
<link rel="stylesheet" type="text/css" href="fonts/ERASMD.ttf">
<!-- jQuery -->
...
<div id="carousel-example-generic" class="carousel intro slide">
	...
	<div class="carousel-inner" role="listbox">
		<div class="hero-image image-shrink">
		...
		<div class="item active">
			<div class="carousel-caption">
				...
				<img src="img/susl.png" alt="logo SOCS" data-animation="animated zoomIn"/>
				<img src="img/cis.png" alt="logo SOCS" data-animation="animated zoomIn"/>
				<img src="img/socs.png" alt="logo SOCS" data-animation="animated zoomIn"/>
				<!-- <img src="img/ieee.png" alt="logo SOCS" data-animation="animated zoomIn"/> -->
	...
	<div class="row">
		<div class="col-lg-10 col-lg-offset-1 text-center">
			...
			<div class="col-md-4">
				<div class="about-icons text-center">
					<div class="">
						<img style="height: 60px; width: 60px;" src="img/venue.png">
	...
	<div class="col-md-12">
		<ul class="tline-holder">
			...
			<div class="tline-item-content">
				...
				<div class="tline-item-txt text-left">
					<div class="meta" style="color: #717070;">
						24<sup>th</sup> of Feb 2018 9.00AM
					</div>
					<h3>Beginning</h3>
					<p style="color: #5e5e5e;">
			...
			<div class="tline-item-content">
				...
				<div class="tline-item-txt text-left">
					<div class="meta" style="color: #717070;">
					25<sup>th</sup> of Feb 2018 7.00AM
					</div>
					<h3>Closing</h3>
					<p style="color: #5e5e5e;">
							Campfire and Awarding Ceremony&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<section id="sponsors" class="sponsors">
	...
	<div class="container">
	<div class="row">
			<div class="col-lg-6 text-center sponsor-logos-heading">
				<video  class="sponsor-video" muted autoplay loop>
					<source src="img/sponvideo.mp4" type="video/mp4">
					Your browser does not support HTML5 video.
				</video>
				<!--<iframe width="560" height="315" src="https://www.youtube.com/embed/ekf9zDy_H3I?autoplay=1&controls=0&showinfo=0&loop=1" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>-->
			</div>
			<div class="col-lg-6 text-center sponsor-logos" style="min-height: 400px">
				<div class="row" style="padding-right: 40px; padding-left: 40px;">
					<!-- <div class="short-div">
						<div style="padding: 0!important" class="col-lg-12 col-md-12 col-sm-12 text-center sponsor-tag">
							<h3 class="section-heading"><b>Platinum Sponsors</b></h3>
						</div>
					</div> -->
					<div class="short-div vertical-center-half">
						...
						<div class="col-lg-10 col-md-10 col-sm-10 col-lg-offset-1 col-md-offset-1 col-sm-offset-1">
							<img class="img img-responsive" src="img/Ideamart.png">
						</div>
					</div>
					<!-- <div class="short-div">
						<div class="col-lg-12 col-md-12 col-sm-12 text-center sponsor-tag">
								<h3 class="section-heading"><b>Other Sponsors</b></h3>
						</div>
					</div> -->
					<!-- <div class="short-div">
						<div class="col-lg-4 col-md-4 col-sm-4 text-center sponsor-tag">
							<div class="short-div">
								<img src="img/hackathons_lk.png">
							</div>
							<div class="short-div">
								<p>Official Onine Events Partner</p>
							</div>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-4 text-center sponsor-tag">
							<div class="short-div">
								<img src="img/lakspace.png">
							</div>
							<div class="short-div">
								<p>Web Hosting Partner</p>
							</div>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-4 text-center sponsor-tag">
							<div class="short-div">
								<img src="img/other_sponsors.png">
							</div>
							<div class="short-div">
								<p>Sponsor type</p>
							</div>
...
<div class="row">
	<div class="col-md-8 col-md-offset-2 text-center">
		<h2 class="section-heading wow bounceInDown">Contact <b>Us</b></h2>
		<hr class="primary">
		<p>
			Keep in touch with us by just dropping an e-mail
		</p>
		<div class="regularform">
			<div class="done" data-target="#contactalert">
				<div class="alert alert-success">
					<button type="button" class="close" data-dismiss="alert">×</button>
					Your message has been sent. Thank you!
				</div>
			</div>
			<form method="post"   action="#contactform"  id="contactform" class="form-group has-error ">
				<div class="row">
				  <div  style="" class="col-md-6 col-sm-6 col-xs-12">
				    <input  name="fname" name="lname" pattern=".{3,}" title="3 characters minimum" style="height: 40px;" type="text" class="form-control" placeholder="Your First Name" required>
				  </div>
				  <div style="" class="col-md-6 col-sm-6 col-xs-12">
				    <input  name="lname" pattern=".{3,}" title="3 characters minimum" style="height: 40px;" type="text" class="form-control" placeholder="Your Last Name" required>
				  </div>
				  <div class="col-md-12 col-sm-12 col-xs-12">
				    <input name="email" style="height: 40px;" type="email" class="form-control" placeholder="Email Address" required>
				    <span style="display: none;" id="email-tic" class="glyphicon glyphicon-ok form-control-feedback form-tic"></span>
				  </div>
				  <div class="col-md-12 col-sm-12 col-xs-12">
...
if(isset($_POST['SubmitButton'])){ //check if form was submitted
 //    $servername = "localhost";
	...
	// }else{
		...
		$sql = "INSERT INTO `Subcribers` (`id`, `firstName`, `lastName`, `email`, `comment`) VALUES (NULL, '$fname', '$lname', '$email', '$comment')";
